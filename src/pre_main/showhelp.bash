...
if [[ "$hlp" = true ]] ; then
	...
	echo "DESCRIPTION"
	echo "-------------------"
	echo "This script runs the Qiime2 pipeline and outputs "
	echo "core-metrics-phylogenetic and taxa-bar-plots. It"
	echo "pulls variables from config.txt and optional_analyses.txt"
	echo ""
	echo "USAGE"
	echo "-------------------"
